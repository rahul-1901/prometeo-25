...
Command: npx gltfjsx@6.5.2 .\public\models\iceberg\low_poly_iceberg_scene.glb 
...
export function Iceberg({opacity,...props}) {
            ...
            <group name="Object_2">
              <group name="RootNode">
                <group name="Iceberg" rotation={[-Math.PI / 2, 0, 0]} scale={100}>
                  <mesh name="Iceberg_Iceberg_0" geometry={nodes.Iceberg_Iceberg_0.geometry} >
                    <meshStandardMaterial {...materials.Iceberg} transparent ref={materialRef} envMapIntensity={2} />
                  </mesh>
                </group>
...
useGLTF.preload('./models/iceberg/low_poly_iceberg_scene.glb')